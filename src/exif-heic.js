 ...
 * Some modifications made to work with TrickTrax
 */
const debug = false;
    ...
    switch (type) {
        ...
        case 5:    // rational = two long values, first is numerator, second is denominator
            if (numValues === 1) {
                ...
                val = {numerator: numerator, denominator: denominator, value: Number(numerator / denominator)};
                ...
                for (n = 0; n < numValues; n++) {
                  ...
                  vals[n] = {numerator: numerator, denominator: denominator, value: Number(numerator / denominator)};
                }
                return vals;
            }
