  ...
  <div>
    ...
    <q-card>
      <q-card-section class="row q-pa-lg">
        <map-element class="col q-mr-md desktop-only" :user-input="coords" marker-msg="Tick observed here." />
        <div>
...
<!--            <q-icon name="edit" class="q-pb-sm"/>-->
            ...
            <map-element class="col q-mr-md mobile-only" style="height: 15rem!important;" :user-input="coords" marker-msg="Tick observed here."  />
